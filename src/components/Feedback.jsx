...
const Feedback = () => {
    return (
        <div className='feedback mt-5 mb-5 '>
            ...
            <span className="subTitle ms-lg-auto me-lg-auto mb-5 mt-3 mt-lg-0 d-flex text-center w-100 w-lg-50 fw-bold ">
            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide>
                    <div className="Testimonial d-flex flex-column">
                        <span className="quote text-center mt-4 mt-lg-3 mb-4">
                            <img className='img-fluid' src={quotes} alt="" />
                        </span>
                        <q className='col-12 col-lg-6 fs-5 mb-4 mt-1 fw-bold text-center m-auto'>
